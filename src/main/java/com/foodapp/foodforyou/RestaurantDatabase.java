...
public class RestaurantDatabase {
    ...
    public void updateRestaurant(String name, Restaurant updatedRestaurant) {
    ...
    public void addMenuItemToRestaurant(String restaurantName, MenuItem menuItem) {
    ...
    public void removeMenuItemFromRestaurant(String restaurantName, MenuItem menuItem) {
        Restaurant restaurant = getRestaurantByName(restaurantName);
        if (restaurant != null) {
